"""
storage.py - Persistence helpers for webcam demo session artifacts
=================================================================
"""
...
LATEST_RUN = RUNS_DIR / "latest_webcam_demo_run.json"
RUN_HISTORY = RUNS_DIR / "webcam_demo_run_history.json"
...
def save_latest_run(run: dict) -> None:
    """Save the latest webcam session and append to history.
...
def load_latest_run() -> dict:
    """Load the most recent webcam session artifact.

"""
main.py - Entry point for Project 26: Cryptocurrency Real-Time Tracker
=======================================================================

Thin-controller module that only orchestrates calls to:
    - operations.py for crypto tracker workflow logic
...
from operations import load_tracker_profile, run_core_flow
from storage import ensure_data_dirs


def main() -> None:
    """Run one complete cryptocurrency tracker session.
    ...
    Workflow:
        ...
        5. Run crypto tracker pipeline (operations.run_core_flow).
    ...
    profile = load_tracker_profile()

    # Print startup guide.
    print(format_startup_guide(config, profile))

    # Run crypto tracker workflow.

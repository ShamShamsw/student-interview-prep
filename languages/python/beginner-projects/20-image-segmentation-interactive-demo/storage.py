"""
storage.py - Persistence layer for Image Segmentation Interactive Demo
======================================================================

Provides:
    - JSON serialization for segmentation sessions
...
def load_json(filename: str):
    ...
    Returns:
        JSON data or empty list if file does not exist.
    """
    ensure_data_dir()
...
def save_latest_session(session_data: dict) -> None:
    """Save the latest segmentation session to a JSON file.

    Parameters:
        session_data (dict): Complete session summary to persist.
    """
    ensure_data_dir()
    filename = "latest_segmentation_demo.json"

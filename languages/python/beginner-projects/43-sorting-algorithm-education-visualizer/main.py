"""Entry point for Project 43: Sorting Algorithm Education Visualizer."""

from display import format_header, format_run_report, format_startup_guide
from models import create_visualizer_config
from operations import load_visualizer_profile, run_core_flow
from storage import ensure_data_dirs


def main() -> None:
    """Run one complete sorting-visualization lesson and benchmark session."""
    ensure_data_dirs()
    print(format_header())

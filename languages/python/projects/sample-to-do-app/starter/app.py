"""Starter TODO CLI app.

Implement the TODO-marked functions to complete the project.
...
def load_todos(path: Path = DB_PATH) -> List[TodoItem]:
    ...
    - Convert each dict into a TodoItem.
    """
    raise NotImplementedError("Implement load_todos")
...
def save_todos(todos: List[TodoItem], path: Path = DB_PATH) -> None:
    ...
    TODO:
    - Serialize list[TodoItem] to list[dict] using asdict.
    - Write pretty JSON to disk.
    """
    raise NotImplementedError("Implement save_todos")


def next_id(todos: List[TodoItem]) -> int:
    """Return the next ID for a new todo item."""
    if not todos:
        return 1
...
def add_todo(text: str, path: Path = DB_PATH) -> TodoItem:
    ...
    TODO:
    - Load existing todos.
    - Create new TodoItem with next_id.
    - Append and save.
    - Return created item.
    """
    raise NotImplementedError("Implement add_todo")
...
def mark_done(item_id: int, path: Path = DB_PATH) -> TodoItem | None:
    ...
    """
    raise NotImplementedError("Implement mark_done")


def remove_todo(item_id: int, path: Path = DB_PATH) -> bool:
    """Remove a todo by id and persist.

    TODO:
    - Remove matching item.
    - Save if an item was removed.
    - Return True when removed, False otherwise.
    """
    raise NotImplementedError("Implement remove_todo")


def clear_all(path: Path = DB_PATH) -> int:
    """Delete all todos and return how many were removed.
    ...
    """
    raise NotImplementedError("Implement clear_all")
